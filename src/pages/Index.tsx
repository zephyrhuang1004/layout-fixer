          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="space-y-4">
              <Card className="p-5 hover:shadow-md hover:border-border/80 transition-all">
                <div className="flex flex-col sm:flex-row gap-5">
                  <div className="shrink-0 flex flex-row sm:flex-col items-center sm:items-start gap-3 sm:w-32 sm:border-r border-border sm:pr-4">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-50 to-blue-100 flex items-center justify-center text-xs font-bold text-blue-600 border border-blue-100">
                      JL
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 text-[10px] font-medium">
                          <Badge variant="secondary">TOEFL 112</Badge>
                          <Badge variant="secondary">GRE 331</Badge>
              ...
              <Card className="p-5 hover:shadow-md hover:border-border/80 transition-all">
                <div className="flex flex-col sm:flex-row gap-5">
                  <div className="shrink-0 flex flex-row sm:flex-col items-center sm:items-start gap-3 sm:w-32 sm:border-r border-border sm:pr-4">
                    <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-xs font-bold text-muted-foreground border border-border">
                      User
                    </div>
                    <div className="flex flex-col">
                      <span className="text-xs font-semibold">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 text-[10px] font-medium">
                          <Badge variant="secondary">IELTS 8.0</Badge>
                          <Badge variant="secondary">GRE 334</Badge>
